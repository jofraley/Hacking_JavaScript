...
* Lab 5:  [Style Feature Layer](./labs/jsapi/style_feature_layer/lab.md)
* Lab 6:  [Extrude data as Polygons in 3D](./labs/jsapi/extrude_polygon_3d/lab.md)
* Lab 7:  [Style a layer popup](./labs/jsapi/style_simple_popup/lab.md)
* Lab 8:  [Search with a Widget](./labs/jsapi/search_with_widget/lab.md)
* Lab 9:  [Search with a Query Task](./labs/jsapi/search_with_query_task/lab.md)
* Lab 10: [Client-side Buffering](./labs/jsapi/buffer_with_geometry_engine/lab.md)
* Lab 11: [Create a JS API 4.x WebMap App](./labs/webmap_apps/create_jsapi_app/lab.md)
* Lab 12: [Create a JS API 4.x WebScene App](./labs/webmap_apps/create_jsapi_scene_app/lab.md)
